...
function Services() {
  return (
    <div>
      <section className="mt-0 pb-3 mb-2 container">
        <div className="row">
          <div className="col-12 text-center py-3">
            <h3 className="font-weight-bold font-size-lg text-accent pt-2 mb-1">
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 services-top-services">
                ...
                <ul>
                  ...
                  <li>
                    <a href="https://www.marham.pk/all-services">View All</a>
                  </li>
                </ul>
              </div>
              ...
              <div className="col-lg-3 col-md-6 services-top-services">
                ...
                <ul>
                  ...
                  <li>
                    <a href="https://www.marham.pk/all-diseases">View All</a>
                  </li>
                </ul>
              </div>
